...
namespace dragon::lumberyard {
    class LUMBERYARD_EXPORT Texture {
      public:
        ...
        static bool noesis_load([[maybe_unused]] BYTE* buffer,
                                [[maybe_unused]] int length,
                                CArrayList<noesisTex_t*>& noe_tex,
                                noeRAPI_t* rapi);

        static bool noesis_check([[maybe_unused]] BYTE* buffer,
                                 [[maybe_unused]] int length,
                                 [[maybe_unused]] noeRAPI_t* rapi);

        static int noesis_tool([[maybe_unused]] int handle,
                               [[maybe_unused]] void* user_data);

        static int noesis_tool_visibility([[maybe_unused]] int handle,
                                          const wchar_t* path,
